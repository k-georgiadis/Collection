A small Greenhouse System with two (2) timed relays and an internal clock. They system uses an LCD to display information. A 4-digit security password login is also included.
