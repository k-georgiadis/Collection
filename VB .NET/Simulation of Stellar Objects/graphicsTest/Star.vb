Public Class Star
    ...
    End Sub
    Friend Sub Init(ByVal sUniverse As Universe,
            ...
            If distanceLength <= Radius + obj.Radius Then
                ...
                If distanceLength <= Radius Or distanceLength <= obj.Radius Then
                    ...
                    If objectRadius >= obj.Radius Then
                        ...
                        Init(objectUniverse, newCenterOfMass, newStarRadius, objectBorderWidth, newcolor, newobjectType,
                             newVelX, newVelY)
                    ...
                    Else
                        ...
                        'Initialize new merged Star.
                        CType(obj, Star).Init(objectUniverse, newCenterOfMass, newStarRadius, objectBorderWidth, newcolor, newobjectType,
                                  newVelX, newVelY)
