...
Public Class blockForm
    ...
    Private Sub createstar(ByVal data() As PointF)
        ...
        newstar.Init(myUniverse, data(0), starRadius, starBorderWidth, myBrush.Color, starType, data(1).X, data(1).Y)
    ...
    Private Sub createplanet(ByVal data() As PointF)
        ...
        newplanet.Init(myUniverse, data(0), planetSize, planetBorderWidth, planetColor, data(1).X, data(1).Y)
    ...
    Private Sub blockForm_MouseMove(sender As Object, e As MouseEventArgs) Handles Me.MouseMove
        ...
        If formLoaded Then
            ...
            If absoluteMousePoint.X >= myUniverse.getImage.Width Or absoluteMousePoint.Y >= myUniverse.getImage.Height Or
    ...
    Private Sub startstars()
        ...
        myUniverse.Stars.Last.Init(myUniverse, pos, starRadius, starBorderWidth, myBrush.Color, starType, 0, -5)
        ...
        'Add and initialize new star to universe.
        myUniverse.AddStar(New Star)
        myUniverse.Stars.Last.Init(myUniverse, pos3, starRadius, starBorderWidth, myBrush.Color, starType, 0, 5)
        AddObjStatsLabel(myUniverse.Stars.Last)
        'Set new random color.
        'myBrush = New SolidBrush(Color.FromArgb(rand.Next(0, 255), rand.Next(0, 255), rand.Next(0, 255)))
    ...
    Private Sub zoomUniverse()
        ...
        If formLoaded And Not onFrame Then
            ...
            'In the first multiplication the scales cancel out, leavine one (1). E.g: 0.5 * (1 / 0.5) = 1
            ...
            myUniverse.ResizeUniverse(zoomValue, offset.X, offset.Y)

            defaultUniverseTransformation = cloneMatrix.Clone
            cloneMatrix.Invert()

            'Update local values.
            clipOffsetX = myUniverse.getGraphics.ClipBounds.X
            clipOffsetY = myUniverse.getGraphics.ClipBounds.Y
    ...
    Private Sub moveUniverse(ByVal originPoint As PointF, ByVal endPoint As PointF)
        ...
        If formLoaded Then
            ...
            Dim clone = myUniverse.getGraphics.Transform.Clone
            defaultUniverseTransformation = clone.Clone
            clone.Invert()
            ...
            'Transform boundaries.
            clone.TransformPoints(left_top_boundary)
            clone.TransformPoints(right_bottom_boundary)
            clipOffsetWidth = Math.Abs(clipOffsetX - left_top_boundary(0).X) 'New clip offsetX width.
            clipOffsetHeight = Math.Abs(clipOffsetY - left_top_boundary(0).Y) 'New clip offsetY width.
            ...
            'Update the universe and give the signal to update it's objects (new clipOffset locations).
            myUniverse.ResizeUniverse(dragStart, offsetX, offsetY)
